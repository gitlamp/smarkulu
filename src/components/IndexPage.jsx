  ...
  <div>
    {data.allContentYaml.edges.map(({node}) =>
      ...
      <Section
        ...
        align="center"
        colClass={{
          center: 'col-12 col-sm-12 col-xl-8'
        }}
      ...
      <Section
        ...
        align="left"
        colClass={{
          left: 'col-12 col-sm-6 col-xl-4',
          right: 'col-12 col-sm-6 col-xl-8'
        }}
        header="Lorem ipsum, dolor sit amet consectetur adipisicing elit."
        body="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae ipsa nemo repudiandae aspernatur neque voluptatibus ut fugit vero fuga obcaecati possimus quod magnam tempore illum rerum, autem nihil repellendus numquam?"
      ...
      <Section
        ...
        align="right"
        colClass={{
          left: 'col-12 col-sm-6 col-xl-8',
          right: 'col-12 col-sm-6 col-xl-4'
        }}
